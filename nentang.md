...
### 7.2. Định hướng Kịch bản Demo & Nút bấm Thử nghiệm Nâng cao (Future Demo Expansion)

Để chuẩn bị cho các đợt mở rộng giao diện và kịch bản bảo vệ chuyên sâu sau này, hệ thống ghi nhận định hướng tích hợp 2 nút bấm mô phỏng đặc thù trên giao diện:

1. **Nút "Kích hoạt Sự cố Quá nhiệt ($T > 85^\circ\text{C}$)" trên Simulator UI**:
   + Mô phỏng tín hiệu cảm biến nhiệt tăng vọt lên $88^\circ\text{C}$ $\rightarrow$ kích hoạt rơ-le ảo tự động ngắt phiên sạc khẩn cấp trong vòng 1 giây, bảo vệ an toàn phần cứng và chốt ngay hóa đơn điện tử cho người dùng.
2. **Nút gạt "Giả lập Ngắt kết nối Gemini AI" trên AI Advisor**:
   + Cho phép hội đồng kiểm chứng tức thời cơ chế **Heuristic Fallback Engine**: Khi tắt kết nối AI, hệ thống tự động duy trì thuật toán chia sẻ công suất theo tỷ lệ và hiển thị huy hiệu vận hành an toàn nội bộ mà không làm gián đoạn trải nghiệm người dùng.
